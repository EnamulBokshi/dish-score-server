...
const router = Router();
router.post("/create-all", authCheck(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.CONSUMER), multerUpload.fields([
    { name: "restaurantImages", maxCount: 10 },
    { name: "dishImages", maxCount: 5 },
    { name: "reviewImages", maxCount: 5 },
]), requestValidator(createUnifiedSchema), UnifiedController.createRestaurantDishReview);
